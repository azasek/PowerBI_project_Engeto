...
**Ski Resorts & Snow Analysis – Power BI Project**

This project is an interactive Power BI dashboard analyzing ski resorts and snow conditions. It combines resort data (location, price, slopes, lifts, altitude) with monthly snow coverage data.
